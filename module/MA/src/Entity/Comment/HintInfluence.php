 ...
 * @ORM\Entity()
 */
class HintInfluence extends AbstractComment
{
	/**
	 * @var PostComment
	 * @ORM\ManyToOne(
     ...
     */
    public function setSource(HintInfluenceInterface $source)
    {
        $this->source = $source;
        return $this;
    }
     ...
     * Set hint.
     *
     * @param HintInfluence hint the value to set.
     * @return HintInfluence.
     */
    public function setInfluence(HintInfluenceInterface $hint)
    {
        $this->setSource($hint);
        return $this;
    }
